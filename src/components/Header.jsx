  ...
  return (
    <div className="fixed w-full bg-[#14121B] text-white font-inter z-999">
      <div className="max-w-[1080px] mx-auto px-[16px] xl:px-0 flex items-center justify-between py-[15px]">
        ...
        <nav
          className={`absolute top-0 flex flex-col gap-[20px] pt-[80px] pl-[40px] bg-[#14121B] w-full h-screen text-white transition-all duration-300 ${
            nav ? "left-0" : "-left-[100%]"
          }`}
        >
          ...
          <IoClose
            className="mt-[25px] mr-[20px] text-[26px] absolute top-0 right-0"
            onClick={handleClick}
          />
        </nav>
      </div>
